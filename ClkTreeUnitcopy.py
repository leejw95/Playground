...
class _CLKTreeUnit(StickDiagram._StickDiagram):
    ...
    def _CalculateDesignParameter(self, 
        ...
        while True:
            ...
            tmp=[]
            tmp2=[]
            for i in range(0,len(self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._DesignParameter['_ViaMet12Met2OnGate1']['_XYCoordinates'])):
                tmp.append([ self._DesignParameter['_ClkTreeElementTop']['_XYCoordinates'][0][0] + self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate1']['_XYCoordinates'][i][0]
                           , self._DesignParameter['_ClkTreeElementTop']['_XYCoordinates'][0][1] + -(self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._ParametersForDesignCalculation['InLinelocation1'])  ])
                tmp2.append([ tmp[i]
                            ,[tmp[i][0], self._DesignParameter['_ClkTreeElementTop']['_XYCoordinates'][0][1] + (-self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate1']['_XYCoordinates'][0][1]) ]     ])
            self._DesignParameter['_ViaMet32Met4OnInLineTop1']['_XYCoordinates'] = tmp
            self._DesignParameter['_ViaMet42Met5OnInLineTop1']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineTop1']['_XYCoordinates']
            self._DesignParameter['_ViaMet52Met6OnInLineTop1']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineTop1']['_XYCoordinates']
            self._DesignParameter['_ViaMet62Met7OnInLineTop1']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineTop1']['_XYCoordinates']
            self._DesignParameter['_InputDivingMet4OnInLineTop1']['_XYCoordinates'] = tmp2

            tmp=[]
            tmp2=[]
            for i in range(0,len(self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._DesignParameter['_ViaMet12Met2OnGate2']['_XYCoordinates'])):
                tmp.append([ self._DesignParameter['_ClkTreeElementTop']['_XYCoordinates'][0][0] + self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate2']['_XYCoordinates'][i][0]
                           , self._DesignParameter['_ClkTreeElementTop']['_XYCoordinates'][0][1] + -(self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._ParametersForDesignCalculation['InLinelocation2'])  ])
                tmp2.append([ tmp[i]
                            ,[tmp[i][0], self._DesignParameter['_ClkTreeElementTop']['_XYCoordinates'][0][1] + (-self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate2']['_XYCoordinates'][0][1]) ]     ])
            self._DesignParameter['_ViaMet32Met4OnInLineTop2']['_XYCoordinates'] = tmp
            self._DesignParameter['_ViaMet42Met5OnInLineTop2']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineTop2']['_XYCoordinates']
            self._DesignParameter['_ViaMet52Met6OnInLineTop2']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineTop2']['_XYCoordinates']
            self._DesignParameter['_ViaMet62Met7OnInLineTop2']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineTop2']['_XYCoordinates']
            self._DesignParameter['_InputDivingMet4OnInLineTop2']['_XYCoordinates'] = tmp2
            
            tmp=[]
            tmp2=[]
            for i in range(0,len(self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._DesignParameter['_ViaMet12Met2OnGate3']['_XYCoordinates'])):
                tmp.append([ self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][0] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate1']['_XYCoordinates'][i][0]
                           , self._DesignParameter['_ClkTreeElementTop']['_XYCoordinates'][0][1] + -(self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._ParametersForDesignCalculation['InLinelocation3'])  ])
                tmp2.append([ tmp[i]
                            ,[tmp[i][0], self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][1] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate1']['_XYCoordinates'][0][1] ]     ])
            self._DesignParameter['_ViaMet32Met4OnInLineTop3']['_XYCoordinates'] = tmp
            self._DesignParameter['_ViaMet42Met5OnInLineTop3']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineTop3']['_XYCoordinates']
            self._DesignParameter['_ViaMet52Met6OnInLineTop3']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineTop3']['_XYCoordinates']
            self._DesignParameter['_ViaMet62Met7OnInLineTop3']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineTop3']['_XYCoordinates']
            self._DesignParameter['_InputDivingMet4OnInLineTop3']['_XYCoordinates'] = tmp2
            
            tmp=[]
            tmp2=[]
            for i in range(0,len(self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._DesignParameter['_ViaMet12Met2OnGate3']['_XYCoordinates'])):
                tmp.append([ self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][0] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate2']['_XYCoordinates'][i][0]
                           , self._DesignParameter['_ClkTreeElementTop']['_XYCoordinates'][0][1] + -(self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._ParametersForDesignCalculation['InLinelocation4'])  ])
                tmp2.append([ tmp[i]
                            ,[tmp[i][0], self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][1] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate2']['_XYCoordinates'][0][1] ]     ])
            self._DesignParameter['_ViaMet32Met4OnInLineTop4']['_XYCoordinates'] = tmp
            self._DesignParameter['_ViaMet42Met5OnInLineTop4']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineTop4']['_XYCoordinates']
            self._DesignParameter['_ViaMet52Met6OnInLineTop4']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineTop4']['_XYCoordinates']
            self._DesignParameter['_ViaMet62Met7OnInLineTop4']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineTop4']['_XYCoordinates']
            self._DesignParameter['_InputDivingMet4OnInLineTop4']['_XYCoordinates'] = tmp2
            
            
            tmp=[]
            tmp2=[]
            for i in range(0,len(self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._DesignParameter['_ViaMet12Met2OnGate3']['_XYCoordinates'])):
                tmp.append([ self._DesignParameter['_ClkTreeElementTop']['_XYCoordinates'][0][0] + self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate5']['_XYCoordinates'][i][0]
                           , self._DesignParameter['_ClkTreeElementTop']['_XYCoordinates'][0][1] + -(self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._ParametersForDesignCalculation['InLinelocation5'])  ])
                tmp2.append([ tmp[i]
                            ,[tmp[i][0], self._DesignParameter['_ClkTreeElementTop']['_XYCoordinates'][0][1] + (-self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate5']['_XYCoordinates'][0][1]) ]     ])
            self._DesignParameter['_ViaMet32Met4OnInLineTop5']['_XYCoordinates'] =tmp
            self._DesignParameter['_ViaMet42Met5OnInLineTop5']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineTop5']['_XYCoordinates']
            self._DesignParameter['_ViaMet52Met6OnInLineTop5']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineTop5']['_XYCoordinates']
            self._DesignParameter['_ViaMet62Met7OnInLineTop5']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineTop5']['_XYCoordinates']
            self._DesignParameter['_InputDivingMet4OnInLineTop5']['_XYCoordinates'] = tmp2
            ...
            tmp=[]
            tmp2=[]
            for i in range(0,len(self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet12Met2OnGate3']['_XYCoordinates'])):
                tmp.append([ self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][0] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate3']['_XYCoordinates'][i][0]
                           , self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][1] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._ParametersForDesignCalculation['InLinelocation1']  ])
                tmp2.append([ tmp[i]
                            ,[tmp[i][0], self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][1] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate3']['_XYCoordinates'][0][1] ]     ])
            self._DesignParameter['_ViaMet32Met4OnInLineBot1']['_XYCoordinates'] = tmp
            self._DesignParameter['_ViaMet42Met5OnInLineBot1']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineBot1']['_XYCoordinates']
            self._DesignParameter['_ViaMet52Met6OnInLineBot1']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineBot1']['_XYCoordinates']
            self._DesignParameter['_ViaMet62Met7OnInLineBot1']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineBot1']['_XYCoordinates']
            self._DesignParameter['_InputDivingMet4OnInLineBot1']['_XYCoordinates'] = tmp2

            tmp=[]
            tmp2=[]
            for i in range(0,len(self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate4']['_XYCoordinates'])):
                tmp.append([ self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][0] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate4']['_XYCoordinates'][i][0]
                           , self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][1] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._ParametersForDesignCalculation['InLinelocation2']  ])
                tmp2.append([ tmp[i]
                            ,[tmp[i][0], self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][1] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate4']['_XYCoordinates'][0][1] ]     ])
            self._DesignParameter['_ViaMet32Met4OnInLineBot2']['_XYCoordinates'] = tmp
            self._DesignParameter['_ViaMet42Met5OnInLineBot2']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineBot2']['_XYCoordinates']
            self._DesignParameter['_ViaMet52Met6OnInLineBot2']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineBot2']['_XYCoordinates']
            self._DesignParameter['_ViaMet62Met7OnInLineBot2']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineBot2']['_XYCoordinates']
            self._DesignParameter['_InputDivingMet4OnInLineBot2']['_XYCoordinates'] = tmp2

            tmp=[]
            tmp2=[]
            for i in range(0,len(self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate3']['_XYCoordinates'])):
                tmp.append([ self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][0] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate3']['_XYCoordinates'][i][0]
                           , self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][1] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._ParametersForDesignCalculation['InLinelocation3']  ])
                tmp2.append([ tmp[i]
                            ,[tmp[i][0], self._DesignParameter['_ClkTreeElementTop']['_XYCoordinates'][0][1] + (-self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate3']['_XYCoordinates'][0][1]) ]     ])
            self._DesignParameter['_ViaMet32Met4OnInLineBot3']['_XYCoordinates'] = tmp
            self._DesignParameter['_ViaMet42Met5OnInLineBot3']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineBot3']['_XYCoordinates']
            self._DesignParameter['_ViaMet52Met6OnInLineBot3']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineBot3']['_XYCoordinates']
            self._DesignParameter['_ViaMet62Met7OnInLineBot3']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineBot3']['_XYCoordinates']
            self._DesignParameter['_InputDivingMet4OnInLineBot3']['_XYCoordinates'] = tmp2
            
            tmp=[]
            tmp2=[]
            for i in range(0,len(self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate4']['_XYCoordinates'])):
                tmp.append([ self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][0] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate4']['_XYCoordinates'][i][0]
                           , self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][1] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._ParametersForDesignCalculation['InLinelocation4']  ])
                tmp2.append([ tmp[i]
                            ,[tmp[i][0], self._DesignParameter['_ClkTreeElementTop']['_XYCoordinates'][0][1] + (-self._DesignParameter['_ClkTreeElementTop']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate4']['_XYCoordinates'][0][1]) ]     ])
            self._DesignParameter['_ViaMet32Met4OnInLineBot4']['_XYCoordinates'] =tmp
            self._DesignParameter['_ViaMet42Met5OnInLineBot4']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineBot4']['_XYCoordinates']
            self._DesignParameter['_ViaMet52Met6OnInLineBot4']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineBot4']['_XYCoordinates']
            self._DesignParameter['_ViaMet62Met7OnInLineBot4']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineBot4']['_XYCoordinates']
            self._DesignParameter['_InputDivingMet4OnInLineBot4']['_XYCoordinates'] =tmp2
            
            tmp=[]
            tmp2=[]
            for i in range(0,len(self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate5']['_XYCoordinates'])):
                tmp.append([ self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][0] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate5']['_XYCoordinates'][i][0]
                           , self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][1] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._ParametersForDesignCalculation['InLinelocation5']  ])
                tmp2.append([ tmp[i]
                            ,[tmp[i][0], self._DesignParameter['_ClkTreeElementBot']['_XYCoordinates'][0][1] + self._DesignParameter['_ClkTreeElementBot']['_DesignObj']._DesignParameter['_ViaMet22Met3OnGate5']['_XYCoordinates'][0][1] ]     ])
            self._DesignParameter['_ViaMet32Met4OnInLineBot5']['_XYCoordinates'] = tmp
            self._DesignParameter['_ViaMet42Met5OnInLineBot5']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineBot5']['_XYCoordinates']
            self._DesignParameter['_ViaMet52Met6OnInLineBot5']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineBot5']['_XYCoordinates']
            self._DesignParameter['_ViaMet62Met7OnInLineBot5']['_XYCoordinates'] = self._DesignParameter['_ViaMet32Met4OnInLineBot5']['_XYCoordinates']
            self._DesignParameter['_InputDivingMet4OnInLineBot5']['_XYCoordinates'] = tmp2
...
if __name__=='__main__':
    ...
    CLKTreeUnitObj._CalculateDesignParameter(
                                    ...
                                    _CLKTreeElementParameters = dict(
                                        ...
                                        _SupplyMetal1YWidth=300, _NumberOfPMOSOutputViaCOY=4 

                                        ),



                                    _TreeLevel = 9, _TotalLevel = 3,
                                    ...
                                    _OutLineIgnore=None,_NumberOfParallelViaCOY=None,
