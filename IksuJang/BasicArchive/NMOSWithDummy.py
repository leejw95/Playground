...
class _NMOS(StickDiagram._StickDiagram):
    ...
    def _CalculateDesignParameter(self, _NMOSNumberofGate=6, _NMOSChannelWidth=600, _NMOSChannellength=30,
                                      _NMOSDummy=True, _GateSpacing=None, _SDWidth=None, _XVT='SLVT', _PCCrit=None):
        """
...
if __name__ == '__main__':
    ...
    InputParams = dict(
        _NMOSNumberofGate=1, _NMOSChannelWidth=1000, _NMOSChannellength=30,
        _NMOSDummy=True, _GateSpacing=None, _SDWidth=None, _XVT='SLVT', _PCCrit=None
    )
    ...
    for ii in range(0, Num_DRCCheck if Mode_DRCCheck else 1):
        ...
        LayoutObj = _NMOS(_Name=cellname)
