...
class NSubRing(StickDiagram._StickDiagram):
    ...
    def _CalculateDesignParameter(self,height=5000,width=5000,contact=2):
        ...
        self._DesignParameter['bot']['_DesignObj']._CalculateDesignParameter(**dict(_NumberOfNbodyCOX=((int(((width - (2 * drc._CoMinEnclosureByOD)) / (drc._CoMinWidth + drc._CoMinSpace2))) - contact) + 0), _NumberOfNbodyCOY=contact, _Met1XWidth=None, _Met1YWidth=None))
        ...
        self._DesignParameter['top']['_DesignObj']._CalculateDesignParameter(**dict(_NumberOfNbodyCOX=((int(((width - (2 * drc._CoMinEnclosureByOD)) / (drc._CoMinWidth + drc._CoMinSpace2))) - contact) + 0), _NumberOfNbodyCOY=contact, _Met1XWidth=None, _Met1YWidth=None))
        ...
        self._DesignParameter['left']['_DesignObj']._CalculateDesignParameter(**dict(_NumberOfNbodyCOX=contact, _NumberOfNbodyCOY=((0 + int(((height - (2 * drc._CoMinEnclosureByOD)) / (drc._CoMinWidth + drc._CoMinSpace2)))) - contact), _Met1XWidth=None, _Met1YWidth=None))
        ...
        self._DesignParameter['right']['_DesignObj']._CalculateDesignParameter(**dict(_NumberOfNbodyCOX=contact, _NumberOfNbodyCOY=((0 + int(((height - (2 * drc._CoMinEnclosureByOD)) / (drc._CoMinWidth + drc._CoMinSpace2)))) - contact), _Met1XWidth=None, _Met1YWidth=None))
...
if __name__ == '__main__':
    ...
    for ii in range(0, Num_DRCCheck if Mode_DRCCheck else 1):
        ...
        LayoutObj = NSubRing(_Name=cellname)
