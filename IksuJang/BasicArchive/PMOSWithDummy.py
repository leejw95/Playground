...
class _PMOS(StickDiagram._StickDiagram):
    ...
    def _CalculateDesignParameter(self, _PMOSNumberofGate=None, _PMOSChannelWidth=None, _PMOSChannellength=30,
...
if __name__ == '__main__':
    ...
    InputParams = dict(
        _PMOSNumberofGate=1, _PMOSChannelWidth=1000, _PMOSChannellength=30,
        _PMOSDummy=True, _GateSpacing=None, _SDWidth=None, _XVT='SLVT', _PCCrit=None
    )
    ...
    for ii in range(0, Num_DRCCheck if Mode_DRCCheck else 1):
        ...
        LayoutObj = _PMOS(_Name=cellname)
