    ...
    def _CalculateDesignParameter(self, _Finger=None, _ChannelWidth=None, _ChannelLength=None, _NPRatio=None,
        ...
        if _VDD2VSSHeight == _VDD2VSSMinHeight and _Finger > 2:  #
            ...
            _MaxLengthofM2 = int(self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter['_XYCoordinatePMOSOutputRouting']['_XYCoordinates'][2][0] \
                                 ...
                                 - _DRCObj._MetalxMinWidth - _DRCObj._MetalxMinSpaceAtCorner)
            ...
            self._DesignParameter['_ViaMet22Met3forInput'] = self._SrefElementDeclaration(_DesignObj=ViaMet22Met3._ViaMet22Met3(_DesignParameter=None,
                                                                                                                                _Name='ViaMet22Met3forInputIn{}'.format(_Name)))[0]
