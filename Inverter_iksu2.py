...
class _Inverter(StickDiagram._StickDiagram):
    ...
    def _CalculateDesignParameter_v2(self,
        ...
        self._DesignParameter['_NMOS']['_DesignObj']._CalculateNMOSDesignParameter(**NMOSparameters)
        self._DesignParameter['_NMOS']['_DesignObj']._DesignParameter['_XYCoordinateNMOSOutputRouting'], \
        self._DesignParameter['_NMOS']['_DesignObj']._DesignParameter['_XYCoordinateNMOSSupplyRouting'] \
            = self._DesignParameter['_NMOS']['_DesignObj']._DesignParameter['_XYCoordinateNMOSSupplyRouting'], \
              self._DesignParameter['_NMOS']['_DesignObj']._DesignParameter['_XYCoordinateNMOSOutputRouting']  # swap source-drain
        ...
        self._DesignParameter['_PMOS']['_DesignObj']._CalculatePMOSDesignParameter(**PMOSparameters)
        self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter['_XYCoordinatePMOSOutputRouting'], \
        self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter['_XYCoordinatePMOSSupplyRouting'] \
            = self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter['_XYCoordinatePMOSSupplyRouting'], \
              self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter[
                  '_XYCoordinatePMOSOutputRouting']  # swap source-drain
        ...
        if _NumViaPMOSMet12Met2CoY == None:  # Default : calculate
            YWidthOfPMOSMet1 = self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']
            # NumViaYPMOS = int((YWidthOfPMOSMet1 - 2 * _DRCObj._VIAxMinEnclosureByMetxTwoOppositeSide) / (_DRCObj._VIAxMinWidth + _DRCObj._VIAxMinSpace)) + 1
            NumViaYPMOS = int((YWidthOfPMOSMet1 - 2 * _DRCObj._Metal1MinEnclosureVia3) / (
                        _DRCObj._VIAxMinWidth + _DRCObj._VIAxMinSpace)) + 1
        else:
            NumViaYPMOS = _NumViaPMOSMet12Met2CoY
        ...
        if Area_M1for_ViaMet12Met2OnPMOSOutput < _DRCObj._Metal1MinArea:
            YWidth_recalculated_byMinArea = self.CeilMinSnapSpacing(
                _DRCObj._Metal1MinArea / self.getXWidth('_ViaMet12Met2OnPMOSOutput', '_Met1Layer'), 2 * MinSnapSpacing)
            self._DesignParameter['_ViaMet12Met2OnPMOSOutput']['_DesignObj']._DesignParameter['_Met1Layer'][
                '_YWidth'] = YWidth_recalculated_byMinArea
        else:
            pass
        ...
        if _NumViaNMOSMet12Met2CoY == None:  # Default : calculate
            YWidthOfNMOSMet1 = self._DesignParameter['_NMOS']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']
            # NumViaYNMOS = int((YWidthOfNMOSMet1 - 2 * _DRCObj._VIAxMinEnclosureByMetxTwoOppositeSide) / (_DRCObj._VIAxMinWidth + _DRCObj._VIAxMinSpace)) + 1
            NumViaYNMOS = int((YWidthOfNMOSMet1 - 2 * _DRCObj._Metal1MinEnclosureVia3) / (
                        _DRCObj._VIAxMinWidth + _DRCObj._VIAxMinSpace)) + 1
        else:
            NumViaYNMOS = _NumViaNMOSMet12Met2CoY
        ...
        # self._DesignParameter['_ViaMet12Met2OnNMOSOutput']['_DesignObj']._CalculateViaMet12Met2DesignParameterMinimumEnclosureX(**VIANMOSMet12)
        self._DesignParameter['_ViaMet12Met2OnNMOSOutput']['_DesignObj']._CalculateDesignParameterSameEnclosure(
            **VIANMOSMet12)
        ...
        if _Finger == 1:
            _VIAMOSPoly2Met1_F1 = copy.deepcopy(ViaPoly2Met1._ViaPoly2Met1._ParametersForDesignCalculation)
            _VIAMOSPoly2Met1_F1[
                '_ViaPoly2Met1NumberOfCOX'] = 1  # Need to Modify (by calculation for wide channel length)
            _VIAMOSPoly2Met1_F1['_ViaPoly2Met1NumberOfCOY'] = 1  # Need to Modify (by user input parameter)
            ...
            self._DesignParameter['_VIANMOSPoly2Met1_F1']['_DesignObj']._CalculateViaPoly2Met1DesignParameter(
                **_VIAMOSPoly2Met1_F1)
            ...
            self._DesignParameter['_VIAPMOSPoly2Met1_F1']['_DesignObj']._CalculateViaPoly2Met1DesignParameter(
                **_VIAMOSPoly2Met1_F1)
        else:
            WidthOfInputXM1 = _DRCObj._CoMinWidth + 2 * _DRCObj._Metal1MinEnclosureCO2  # how?? you have to choose / Need to Modify (by user input parameter) / ambiguous name
        ...
        if DesignParameters._Technology == '028nm':
            DistanceBtwVSS2NMOS1 = (self.getYWidth('PbodyContact', '_PPLayer') + self.getYWidth('_NMOS','_POLayer')) / 2
            DistanceBtwVSS2NMOS2 = 0.5 * (
                        self.getYWidth('PbodyContact', '_ODLayer') + self.getYWidth('_NMOS', '_ODLayer')) \
                                   + _DRCObj._OdMinSpace  # OD Layer(for Pbody) - OD Layer (for NMOS)     OD=RX
            if '_PODummyLayer' in self._DesignParameter['_NMOS']['_DesignObj']._DesignParameter:
                DistanceBtwVSS2NMOS3 = 0.5 * self.getYWidth('PbodyContact', '_ODLayer') \
                                       + 0.5 * self.getYWidth('_NMOS', '_PODummyLayer') \
            ...
            DistanceBtwVD2PMOS2 = 0.5 * self._DesignParameter['NbodyContact']['_DesignObj']._DesignParameter['_ODLayer']['_YWidth'] \
                                  ...
                                  + _DRCObj._OdMinSpace  # OD Layer(for Nbody) - OD Layer (for PMOS)     OD=RX
            if '_PODummyLayer' in self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter:
                DistanceBtwVDD2PMOS3 = 0.5 * \
                                       self._DesignParameter['NbodyContact']['_DesignObj']._DesignParameter['_ODLayer']['_YWidth'] \
                                       + 0.5 * \
                                       self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter['_PODummyLayer']['_YWidth'] \
                                       + _DRCObj._PolygateMinSpace2OD  # OD Layer(for Nbody) - PO Dummy Layer (for PMOS)     OD=RX
            else:
                DistanceBtwVDD2PMOS3 = 0
            DistanceBtwVDD2PMOS4 = 0.5 * \
                                   self._DesignParameter['NbodyContact']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] \
                                   + 0.5 * max(
                self._DesignParameter['_ViaMet12Met2OnPMOSOutput']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'],
                self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']) \
                                   + _DRCObj._Metal1MinSpace2  # Need to Modify
            DistanceBtwVDD2PMOS_minimum = max(DistanceBtwVDD2PMOS1, DistanceBtwVD2PMOS2, DistanceBtwVDD2PMOS3,
                                              DistanceBtwVDD2PMOS4)
        ...
        if _Finger != 1:
            ...
            DistanceBtwNMOS2PolyInput = 0.5 * \
                                        self._DesignParameter['_NMOS']['_DesignObj']._DesignParameter['_PODummyLayer'][
                                            '_YWidth'] \
                                        + _LengthNPolyDummytoGoUp_Finger2 \
                                        + 0.5 * \
                                        self._DesignParameter['_VIANMOSPoly2Met1_F1']['_DesignObj']._DesignParameter[
                                            '_POLayer']['_YWidth']
            DistanceBtwPMOS2PolyInput = 0.5 * \
                                        self._DesignParameter['_VIAPMOSPoly2Met1_F1']['_DesignObj']._DesignParameter[
                                            '_POLayer']['_YWidth'] \
                                        + _LengthPPolyDummytoGoUp_Finger2 \
                                        + 0.5 * \
                                        self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter['_PODummyLayer'][
                                            '_YWidth']
        else:
            raise NotImplementedError
        ...
        if _VDD2VSSHeight == None:
            ...
            if _VDD2VSSHeight < _VDD2VSSMinHeight:
                print("ERROR! VDD2VSSMinHeight =",
                      _VDD2VSSMinHeight)  # Need to Print More information(input parameter...)
                raise NotImplementedError
        ...
        for i in range(0, len(
                self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter['_XYCoordinatePMOSOutputRouting'][
                    '_XYCoordinates'])):  # Assumption : same MOSFETs' fingers
        ...
        if _Finger != 1:
            _LenBtwPMOSGates = \
            self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter['_XYCoordinatePMOSGateRouting'][
                '_XYCoordinates'][-1][0] \
            - self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter['_XYCoordinatePMOSGateRouting'][
                '_XYCoordinates'][0][0] \
            + _ChannelLength
            _LenBtwNMOSGates = \
            self._DesignParameter['_NMOS']['_DesignObj']._DesignParameter['_XYCoordinateNMOSGateRouting'][
                '_XYCoordinates'][-1][0] \
            - self._DesignParameter['_NMOS']['_DesignObj']._DesignParameter['_XYCoordinateNMOSGateRouting'][
                '_XYCoordinates'][0][0] \
            + _ChannelLength
            ...
            _LenBtwPMOSGates = self._DesignParameter['_VIAPMOSPoly2Met1_F1']['_XYCoordinates'][0][0] \
                               + self.getXWidth('_VIAPMOSPoly2Met1_F1', '_POLayer') / 2 \
                               - self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter[
                                   '_XYCoordinatePMOSGateRouting']['_XYCoordinates'][0][0] \
                               + self.getXWidth('_PMOS', '_POLayer') / 2
            _LenBtwNMOSGates = self._DesignParameter['_VIANMOSPoly2Met1_F1']['_XYCoordinates'][0][0] \
                               + self.getXWidth('_VIANMOSPoly2Met1_F1', '_POLayer') / 2 \
                               - self._DesignParameter['_NMOS']['_DesignObj']._DesignParameter[
                                   '_XYCoordinateNMOSGateRouting']['_XYCoordinates'][0][0] \
                               + self.getXWidth('_NMOS', '_POLayer') / 2
        else:
            raise NotImplementedError
        ...
        self._DesignParameter['_PolyRouteXOnPMOS']['_XWidth'] = _LenBtwPMOSGates
        self._DesignParameter['_PolyRouteXOnNMOS']['_XWidth'] = _LenBtwNMOSGates
        self._DesignParameter['_PolyRouteXOnPMOS'][
            '_YWidth'] = _DRCObj._CoMinWidth + 2 * _DRCObj._CoMinEnclosureByPOAtLeastTwoSide  # calculated when only one row -> should be changed
        self._DesignParameter['_PolyRouteXOnNMOS'][
            '_YWidth'] = _DRCObj._CoMinWidth + 2 * _DRCObj._CoMinEnclosureByPOAtLeastTwoSide
        ...
        tmpOutputRoutingM1Y = []
        for i in range(0, (len(
                self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter['_XYCoordinatePMOSOutputRouting']['_XYCoordinates']) + 1) // 2):
            # tmpOutputRoutingM1Y.append([CoordCalc.Add(self._DesignParameter['_PMOS']['_XYCoordinates'][0],
            #                                           self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter[
            #                                               '_XYCoordinatePMOSOutputRouting']['_XYCoordinates'][2 * i]),
            #                             CoordCalc.Add(self._DesignParameter['_NMOS']['_XYCoordinates'][0],
            #                                           self._DesignParameter['_NMOS']['_DesignObj']._DesignParameter[
            #                                               '_XYCoordinateNMOSOutputRouting']['_XYCoordinates'][2 * i])
            #                             ])  #
        ...
        if DesignParameters._Technology in ('028nm', '065nm'):
            ...
            if (DesignParameters._Technology == '028nm') and (
                    tmpCount_GateViaLayer > 1) and flag_horizontal_inputvia_PCCOM1:
                # M1V1M2
                # (1) Normal width
                _LengthM1_VIAPMOSPoly2Met1 = \
                self._DesignParameter['_VIAPMOSPoly2Met1']['_DesignObj']._DesignParameter['_Met1Layer']['_XWidth']
                _NumViaInputM12 = int((
                                                  _LengthM1_VIAPMOSPoly2Met1 - _DRCObj._VIAxMinWidth - 2 * _DRCObj._VIAxMinEnclosureByMetxTwoOppositeSide)
                                      // (_DRCObj._VIAxMinWidth + _DRCObj._VIAxMinSpace)) + 1
                ...
                self._DesignParameter['_ViaMet12Met2forInput'][
                    '_DesignObj']._CalculateViaMet12Met2DesignParameterMinimumEnclosureY(**_ViaMet12Met2forInput)

                # (2) RightMost
                if flag_exception_rightmost:
                    _LengthM1_VIAPMOSPoly2Met1_RightMost = \
                    self._DesignParameter['_VIAMOSPoly2Met1RightMost']['_DesignObj']._DesignParameter['_Met1Layer'][
                        '_XWidth']
                    _NumViaInputM12_RightMost = int((
                                                                _LengthM1_VIAPMOSPoly2Met1_RightMost - _DRCObj._VIAxMinWidth - 2 * _DRCObj._VIAxMinEnclosureByMetxTwoOppositeSide)
                                                    // (_DRCObj._VIAxMinWidth + _DRCObj._VIAxMinSpace)) + 1
                    ...
                    self._DesignParameter['_ViaMet12Met2forInput2'][
                        '_DesignObj']._CalculateViaMet12Met2DesignParameterMinimumEnclosureY(**_ViaMet12Met2forInput2)
                ...
                self._DesignParameter['_CLKMet2InRouting']['_Width'] = \
                self._DesignParameter['_ViaMet12Met2forInput']['_DesignObj']._DesignParameter['_Met2Layer']['_YWidth']
                self._DesignParameter['_CLKMet2InRouting']['_XYCoordinates'] = [
                    [self._DesignParameter['_ViaMet12Met2forInput']['_XYCoordinates'][0],
                     self._DesignParameter['_ViaMet12Met2forInput']['_XYCoordinates'][-1]]]
                if flag_exception_rightmost:
                ...
                _NumViaInputM12 = int((
                                                  _LengthM1Y_VIAMOSPoly2Met1 - _DRCObj._VIAxMinWidth - 2 * _DRCObj._VIAxMinEnclosureByMetxTwoOppositeSide)
                                      // (_DRCObj._VIAxMinWidth + _DRCObj._VIAxMinSpace)) + 1
                ...
                self._DesignParameter['_ViaMet12Met2forInput'] = self._SrefElementDeclaration(
                    _DesignObj=ViaMet12Met2._ViaMet12Met2(_Name='ViaMet12Met2forInputIn{}'.format(_Name)))[0]
                self._DesignParameter['_ViaMet12Met2forInput'][
                    '_DesignObj']._CalculateViaMet12Met2DesignParameterMinimumEnclosureX(**_ViaMet12Met2forInput)
        ...
        self._DesignParameter['_VSSpin']['_XYCoordinates'] = [[0, 0]]
        self._DesignParameter['_VDDpin']['_XYCoordinates'] = [[0, _VDD2VSSHeight]]
        self._DesignParameter['_Inputpin']['_XYCoordinates'] = [[round((self._DesignParameter['_InputRouting'][
                                                                            '_XYCoordinates'][0][0][0] +
                                                                        self._DesignParameter['_InputRouting'][
                                                                            '_XYCoordinates'][0][1][0]) / 2),
                                                                 round((self._DesignParameter['_InputRouting'][
                                                                            '_XYCoordinates'][0][0][1] +
                                                                        self._DesignParameter['_InputRouting'][
                                                                            '_XYCoordinates'][0][1][1]) / 2)]]
        self._DesignParameter['_Outputpin']['_XYCoordinates'] = [[round((self._DesignParameter['_OutputRouting'][
                                                                             '_XYCoordinates'][0][0][0] +
                                                                         self._DesignParameter['_OutputRouting'][
                                                                             '_XYCoordinates'][0][1][0]) / 2),
        ...
        if _SupplyLine:
            ...
            self._DesignParameter['_Met2LayerOnSupply']['_XWidth'] = self.getXWidth('NbodyContact', '_Met1Layer')
            self._DesignParameter['_Met2LayerOnSupply']['_YWidth'] = self.getYWidth('NbodyContact', '_Met1Layer')

            self._DesignParameter['_Met2LayerOnSupply']['_XYCoordinates'] = self._DesignParameter['NbodyContact']['_XYCoordinates'] + \
                                                                            self._DesignParameter['PbodyContact']['_XYCoordinates']
            ...
            self._DesignParameter['_ViaMet12Met2OnSupply']['_DesignObj']._CalculateViaMet12Met2DesignParameterMinimumEnclosureY(**_ViaVDDMet12Met2)
            self._DesignParameter['_ViaMet12Met2OnSupply']['_XYCoordinates'] = self._DesignParameter['NbodyContact']['_XYCoordinates'] + \
                                                                               self._DesignParameter['PbodyContact']['_XYCoordinates']
    ...
    def _CalculateSupplyRails(self, _NumSupplyCoX, _NumSupplyCoY, _SupplyMet1XWidth, _SupplyMet1YWidth):
        """
        ...
        # 1-1) Calculate the Number of Contacts --------------------------------------------------------------------------
        # NumCoYOnSupplyRail = _NumSupplyCoY if _NumSupplyCoY != None else 1  # default 1
        #
        # if _NumSupplyCoX != None:
        #     NumCoXOnSupplyRail = _NumSupplyCoX
        # else:
        #     XWidthOfPMOS = self._DesignParameter['_PMOS']['_DesignObj']._DesignParameter['_PPLayer']['_XWidth']
        #     NumCoXOnSupplyRail_case1 = int(XWidthOfPMOS / (_DRCObj._CoMinWidth + _DRCObj._CoMinSpace)) + 1
        #     NumCoXOnSupplyRail_case2 = int(XWidthOfPMOS / (_DRCObj._CoMinWidth + _DRCObj._CoMinSpace2)) + 1
        #
        ...
        # 1-2) Calculate the Number of Contacts --------------------------------------------------------------------------
        NumCoYOnSupplyRail = _NumSupplyCoY if _NumSupplyCoY != None else 1  # default 1
        ...
        PbodyParameters.update({'_NumberOfPbodyCOX': NumCoXOnSupplyRail, '_NumberOfPbodyCOY': NumCoYOnSupplyRail})
...
if __name__ == '__main__':
    ...
    libname = 'INV_x2_isj_v1_test'
    cellname = 'INV_x2_isj_v1_test'
    ...
    InputParams = dict(
        ...
        _DistanceBtwFinger=150,        # default(None) MinimumValue by DRC
        _VDD2VSSHeight=1800,
        _VDD2PMOSHeight=500,
        _VSS2NMOSHeight=300,
