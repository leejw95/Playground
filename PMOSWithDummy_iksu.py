...
class _PMOS(StickDiagram._StickDiagram):
    ...
    # Input Variable
    def _CalculatePMOSDesignParameter(self, _PMOSNumberofGate=None, _PMOSChannelWidth=None, _PMOSChannellength=None, _PMOSDummy=False, _SLVT='SLVT'):
        print ('#########################################################################################################')
...
##############################################################################################################################################################################
        ...
        if DesignParameters._Technology == '028nm':
            if (_SLVT == True) or (_SLVT == 'SLVT'):
                ...
                self._DesignParameter['_SLVTLayer']['_XWidth'] = self._DesignParameter['_ODLayer']['_XWidth'] + 2 * _DRCObj._SlvtMinExtensionOnOD  # Weird DRC rule
            ...
            if _SLVT == 'LVT':
                ...
                # SLVT Dummy Layer XWidth and YWidth Setting
                self._DesignParameter['_LVTLayer']['_XWidth'] = self._DesignParameter['_ODLayer']['_XWidth'] + 2 * _DRCObj._SlvtMinExtensionOnOD  # Weird DRC rule
            ...
            if _SLVT == 'HVT':
                ...
                # SLVT Dummy Layer XWidth and YWidth Setting
                self._DesignParameter['_HVTLayer']['_XWidth'] = self._DesignParameter['_ODLayer']['_XWidth'] + 2 * _DRCObj._SlvtMinExtensionOnOD  # Weird DRC rule
        ...
        if (_PMOSNumberofGate % 2) == 0:
            for i in range(0, _PMOSNumberofGate / 2 + 1):
                tmp.append([_XYCoordinateOfPMOS[0][0] - _PMOSNumberofGate / 2 * _LengthPMOSBtwMet1 + i * 2 * _LengthPMOSBtwMet1, _XYCoordinateOfPMOS[0][1]])
        elif (_PMOSNumberofGate % 2) == 1:
            for i in range(0,(_PMOSNumberofGate - 1) / 2 + 1):
                tmp.append([_XYCoordinateOfPMOS[0][0] - ((_PMOSNumberofGate + 1) / 2 - 0.5) * _LengthPMOSBtwMet1 + i * 2 * _LengthPMOSBtwMet1, _XYCoordinateOfPMOS[0][1]])
        ...
        if (_PMOSNumberofGate % 2) == 0:
            for i in range(0, _PMOSNumberofGate / 2):
                tmp.append([_XYCoordinateOfPMOS[0][0] - _PMOSNumberofGate / 2 * _LengthPMOSBtwMet1 + (i * 2 + 1) * _LengthPMOSBtwMet1, _XYCoordinateOfPMOS[0][1]])
        elif (_PMOSNumberofGate % 2) == 1:
            for i in range(0, (_PMOSNumberofGate - 1) / 2 + 1):
                tmp.append([_XYCoordinateOfPMOS[0][0] - ((_PMOSNumberofGate + 1) / 2 - 0.5) * _LengthPMOSBtwMet1 + (i * 2 + 1) * _LengthPMOSBtwMet1, _XYCoordinateOfPMOS[0][1]])
        ...
        for i in range(0, _PMOSNumberofGate):
            if (_PMOSNumberofGate % 2) == 0:
                tmp.append([_XYCoordinateOfPMOS[0][0] - (_PMOSNumberofGate / 2 - 0.5) * _LengthPMOSBtwMet1 + i * _LengthPMOSBtwMet1, _XYCoordinateOfPMOS[0][1]])
            elif (_PMOSNumberofGate % 2) == 1:
                tmp.append([_XYCoordinateOfPMOS[0][0] - (_PMOSNumberofGate - 1) / 2 * _LengthPMOSBtwMet1 + i * _LengthPMOSBtwMet1,   _XYCoordinateOfPMOS[0][1]])
