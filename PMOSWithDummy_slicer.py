...
class _PMOS(StickDiagram._StickDiagram):
    ...
    def _CalculatePMOSDesignParameter(self, _PMOSNumberofGate=None, _PMOSChannelWidth=None, _PMOSChannellength=None, _PMOSDummy=False, _SLVT=False):
        ...
        ###################################### Poly Layer added from Dummy to avoid DRC ####################################################
        ...
        self._DesignParameter['_POLayerGate']['_XWidth'] = _PMOSChannellength
        ...
        for i in range(0, _PMOSNumberofGate):
            if (_PMOSNumberofGate % 2) == 0:
                _xycoordinatetmp = [_XYCoordinateOfPMOS[0][0] - ( _PMOSNumberofGate / 2 - 0.5) \
                                 *  _LengthPMOSBtwPO + i *  _LengthPMOSBtwPO,  _XYCoordinateOfPMOS[0][1] - self._DesignParameter['_POLayer']['_YWidth']/2 - self._DesignParameter['_POLayerGate']['_YWidth']/2]
            elif (_PMOSNumberofGate % 2) == 1:
                _xycoordinatetmp = [_XYCoordinateOfPMOS[0][0] - ( _PMOSNumberofGate - 1) / 2 \
                                 *  _LengthPMOSBtwPO + i *  _LengthPMOSBtwPO, _XYCoordinateOfPMOS[0][1] - self._DesignParameter['_POLayer']['_YWidth']/2 - self._DesignParameter['_POLayerGate']['_YWidth']/2]
            tmp.append(_xycoordinatetmp)
        ...
        if _PMOSDummy == True:
            ...
            if (_PMOSNumberofGate % 2) == 0: # When the number of finger is even
                _xycoordinatetmp_dummy = [
                                   [_XYCoordinateOfPMOS[0][0] - ( _PMOSNumberofGate / 2 - 0.5) *  _LengthPMOSBtwPO + 0 *  _LengthPMOSBtwPO - _DRCObj.DRCPolygateMinSpace(_DRCObj._CoMinWidth +  _DRCObj._PolygateMinSpace2Co + _DRCObj._CoMinEnclosureByOD + _DRCObj._PolygateMinSpace2OD ) - (float(self._DesignParameter['_PODummyLayer']['_XWidth'])/2 + float(self._DesignParameter['_POLayer']['_XWidth'])/2) ,  _XYCoordinateOfPMOS[0][1] + float(self._DesignParameter['_POLayer']['_YWidth'])/2 - float(self._DesignParameter['_PODummyLayer']['_YWidth'])/2-25],
