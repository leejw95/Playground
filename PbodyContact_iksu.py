...
class _PbodyContact(StickDiagram._StickDiagram):
    ...
    def _CalculatePbodyContactDesignParameter(self,  _NumberOfPbodyCOX=None, _NumberOfPbodyCOY=None,  _Met1XWidth=None, _Met1YWidth=None):
        ...
        if DesignParameters._Technology == '028nm':  # Need to Merge if-else state -> in DRC level, check design technology and setup DRC value.
            ...
            if self._DesignParameter['_PPLayer']['_YWidth'] < _DRCObj._PpMinWidth:
                self._DesignParameter['_PPLayer']['_YWidth'] = _DRCObj._PpMinWidth
        else:
        ...
        self._DesignParameter['_Met1Layer']['_XWidth'] = self._DesignParameter['_ODLayer']['_XWidth'] if (_Met1XWidth == None) else _Met1XWidth
        self._DesignParameter['_Met1Layer']['_YWidth'] = self._DesignParameter['_ODLayer']['_YWidth'] if (_Met1YWidth == None) else _Met1YWidth
