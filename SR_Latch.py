...
#        del LengthBtwPODummy2
        ...
        self._DesignParameter['NbodyContact']['_XYCoordinates'] = [[MiddleCoordinateX, _VDD2VSSHeightAtOneSide], [MiddleCoordinateX, -_VDD2VSSHeightAtOneSide]]
...
#                                     [self._DesignParameter['_NMOS1']['_DesignObj']._DesignParameter['_XYCoordinateNMOSOutputRouting']['_XYCoordinates'][0][0] + self._DesignParameter['_NMOS1']['_XYCoordinates'][0][0], self._DesignParameter['_NMOS1']['_XYCoordinates'][0][1] + self._DesignParameter['_NMOS1']['_DesignObj']._DesignParameter['_XYCoordinateNMOSOutputRouting']['_XYCoordinates'][0][1]]])
        ...
        self._DesignParameter['_AdditionalMet4Routing3']['_XYCoordinates'] = [[[self._DesignParameter['_VIAPMOS1Poly2Met1']['_XYCoordinates'][1][0], self._DesignParameter['_VIAPMOS1Poly2Met1']['_XYCoordinates'][1][1]], [self._DesignParameter['_VIAPMOS1Poly2Met1']['_XYCoordinates'][1][0], (self._DesignParameter['_VIAPMOS1Poly2Met1']['_XYCoordinates'][0][1] + self._DesignParameter['_VIAPMOS1Poly2Met1']['_XYCoordinates'][2][1]) / 2 + _DRCObj._MetalxMinWidth / 2]]]
        ...
        self._DesignParameter['_AdditionalMet4Routing1']['_XYCoordinates'] = [[[self._DesignParameter['_NMOS4']['_XYCoordinates'][1][0], self._DesignParameter['_NMOS4']['_XYCoordinates'][1][1] - _DRCObj._MetalxMinWidth / 2], [self._DesignParameter['_PMOS4']['_XYCoordinates'][1][0], (self._DesignParameter['_VIAPMOS4Poly2Met1']['_XYCoordinates'][0][1] + self._DesignParameter['_VIAPMOS4Poly2Met1']['_XYCoordinates'][2][1]) / 2]], \
                                                                             [[self._DesignParameter['_NMOS3']['_XYCoordinates'][0][0], self._DesignParameter['_AdditionalMet32Met4OnGate3']['_XYCoordinates'][0][1]], [self._DesignParameter['_NMOS3']['_XYCoordinates'][1][0], self._DesignParameter['_AdditionalMet32Met4OnGate3']['_XYCoordinates'][1][1]]], \
                                                                              [[self._DesignParameter['_NMOS4']['_XYCoordinates'][1][0] + self._DesignParameter['_NMOS4']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][0] - _DRCObj._MetalxMinWidth / 2, self._DesignParameter['_NMOS4']['_XYCoordinates'][1][1]], [self._DesignParameter['_NMOS4']['_XYCoordinates'][1][0], self._DesignParameter['_NMOS4']['_XYCoordinates'][1][1]]]]
        ...
        self._DesignParameter['_VDDpin']['_XYCoordinates'] = [[0, _VDD2VSSHeightAtOneSide], [0, -(_VDD2VSSHeightAtOneSide)]]
        ...
        ########################### Additonal Power Line Generation ###############################
        ...
        self._DesignParameter['_Met2LayerVDD']['_XWidth'] = self._DesignParameter
