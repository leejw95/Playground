...
class _ShiftRegister(StickDiagram._StickDiagram):
    ...
    def _CalculateShiftRegister(self, DFF1_param={'_TGFinger':1, '_TGChannelWidth':200, '_TGChannelLength':30, '_TGNPRatio':2,
                        ...
                        DFF2_param={'_TGFinger':1, '_TGChannelWidth':200, '_TGChannelLength':30, '_TGNPRatio':2,
        ...
        print(
            '#########################################################################################################')
        print(
            '                                   {}  Shift_Register Calculation Start                                         '.format(
        ...
        self._DesignParameter['dlatch1']=self._SrefElementDeclaration(_DesignObj=D_FF._DLatch(_Name='dlatch1'.format(_Name)))[0]
        self._DesignParameter['dlatch1']['_DesignObj']._CalculateDLatch(**dict(**DFF1_param))

        self._DesignParameter['dlatch2']=self._SrefElementDeclaration(_DesignObj=D_FF._DLatch(_Name='dlatch2'.format(_Name)),_Reflect = [1,0,0], _Angle = 0)[0]
        self._DesignParameter['dlatch2']['_DesignObj']._CalculateDLatch(**dict(**DFF2_param))
