...
class SlicerWithSRLatchX4Obj (StickDiagram._StickDiagram) :
    ...
    def _CalculateDesignParameter(self, _SRFinger1 = None, _SRFinger2 = None, _SRFinger3 = None, _SRFinger4 = None, \
        ...
        self._DesignParameter['_Met6RoutingCLK0']['_XYCoordinates'].append([[self._DesignParameter['_Met7RoutingCLK0']['_XYCoordinates'][-1][1][0], self._DesignParameter['_Met7RoutingCLK0']['_XYCoordinates'][-1][1][1] + _CLKRoutingMetThickness / 2], [self._DesignParameter['_Met7RoutingCLK0']['_XYCoordinates'][-1][1][0], _MidofCLKIn0_270 + 2 * _Cen2CenBtwMet]])
        self._DesignParameter['_Met6RoutingCLK90']['_XYCoordinates'].append([[self._DesignParameter['_Met7RoutingCLK90']['_XYCoordinates'][-1][1][0], self._DesignParameter['_Met7RoutingCLK90']['_XYCoordinates'][-1][1][1] + _CLKRoutingMetThickness / 2], [self._DesignParameter['_Met7RoutingCLK90']['_XYCoordinates'][-1][1][0], _MidofCLKIn0_270 + _Cen2CenBtwMet]])
        self._DesignParameter['_Met6RoutingCLK180']['_XYCoordinates'].append([[self._DesignParameter['_Met7RoutingCLK180']['_XYCoordinates'][-1][1][0], self._DesignParameter['_Met7RoutingCLK180']['_XYCoordinates'][-1][1][1] - _CLKRoutingMetThickness / 2], [self._DesignParameter['_Met7RoutingCLK180']['_XYCoordinates'][-1][1][0], _MidofCLKIn0_270 - _Cen2CenBtwMet]])
        self._DesignParameter['_Met6RoutingCLK270']['_XYCoordinates'].append([[self._DesignParameter['_Met7RoutingCLK270']['_XYCoordinates'][-1][1][0], self._DesignParameter['_Met7RoutingCLK270']['_XYCoordinates'][-1][1][1] - _CLKRoutingMetThickness / 2], [self._DesignParameter['_Met7RoutingCLK270']['_XYCoordinates'][-1][1][0], _MidofCLKIn0_270 - 2 * _Cen2CenBtwMet]])
