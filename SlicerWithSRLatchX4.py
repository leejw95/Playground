...
class _SlicerWithSRLatchX4 (StickDiagram._StickDiagram) :
    ...
    def _CalculateDesignParameter(self, _SRFinger1 = None, _SRFinger2 = None, _SRFinger3 = None, _SRFinger4 = None, \
        ...
        if _SLSRInvSupplyLineX4 == True :
            ...
            self._DesignParameter['_Met4VSSRouting']['_Width'] = int(max(self._DesignParameter['_ViaMet32Met4forVSS']['_DesignObj']._DesignParameter['_Met4Layer']['_XWidth'], self._DesignParameter['_ViaMet42Met5forVSS']['_DesignObj']._DesignParameter['_Met4Layer']['_XWidth']))
            ...
            self._DesignParameter['_AdditionalLineVDDMet4'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL4'][0], _Datatype=DesignParameters._LayerMapping['METAL4'][1], _XYCoordinates=[], _Width=400)
