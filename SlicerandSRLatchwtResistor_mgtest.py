...
if __name__ == '__main__':
    ...
    _ResistorWidth = 2105
    _ResistorLength = 2005  ## minimum : 400
    ...
    _SLPMOSFinger = 2
    _SLPMOSChannelWidth = 955
    _SLNMOSFinger = 13
    _SLDATAinputNMOSFinger = 15
    _SLCLKinputNMOSFinger = 13
    _SLNMOSChannelWidth = 487
    _SLCLKinputNMOSChannelWidth = 585
    _SLChannelLength = 30
