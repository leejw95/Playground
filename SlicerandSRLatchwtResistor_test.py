...
if __name__ == '__main__':
    for _ in range(0, 100) :
        ...
        _SRRandWidth = random.randrange(700,1400,10)
        ...
        _SLPMOSChannelWidth = random.randrange(700,3500,10)
        _SLNMOSFinger = random.randint(1,15)
        _SLDATAinputNMOSFinger = random.randint(2,15)
        _SLCLKinputNMOSFinger = random.randint(1,15)
        _SLNMOSChannelWidth = random.randrange(700,3500,10)
        _SLCLKinputNMOSChannelWidth = random.randrange(700,3500,10)
        _SLChannelLength = 100

        _SLDummy = False
        _SLXVT = 'LVT'
        _SLGuardringWidth = 700
        _SLGuardring = True
        _SLSlicerGuardringWidth = 700
        ...
        _InvChannelWidth = random.randrange(700,1400,10)
