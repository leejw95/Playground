...
class _PSubring(StickDiagram._StickDiagram):
    ...
    def __init__(self, _DesignParameter=None, _Name=None):
        ...
        if _DesignParameter != None:
            ...
            self._DesignParameter = dict(
                _ODLayerx=self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['DIFF'][0],
                                                           _Datatype=DesignParameters._LayerMapping['DIFF'][1],
                                                           _XYCoordinates=[], _XWidth=400, _YWidth=400),
                _ODLayery=self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['DIFF'][0],
                                                           _Datatype=DesignParameters._LayerMapping['DIFF'][1],
                                                           _XYCoordinates=[], _XWidth=400, _YWidth=400),
                _Met1Layerx=self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0],
                                                             _Datatype=DesignParameters._LayerMapping['METAL1'][1],
                                                             _XYCoordinates=[], _XWidth=400, _YWidth=400),
                _Met1Layery=self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0],
                                                             _Datatype=DesignParameters._LayerMapping['METAL1'][1],
                                                             _XYCoordinates=[], _XWidth=400, _YWidth=400),
                _PPLayer=self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['PIMP'][0],
                ...
                _COLayer=self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['CONT'][0],
                                                          ...
                                                          _XYCoordinates=[], _XWidth=400, _YWidth=400),
                _NWLayer=self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['NWELL'][0],
    ...
    def _CalculatePSubring(self, _PType=True, _XWidth=None, _YWidth=None, _Width=None):
        print (
            '#########################################################################################################')
        print (
            '                                    {}  PSubring Calculation Start                                       '.format(
        ...
        print (
            '##############################     CONT Layer Calcuation    ##############################################')
        self._DesignParameter['_COLayer']['_XWidth'] = _DRCObj._CoMinWidth
        self._DesignParameter['_COLayer']['_YWidth'] = _DRCObj._CoMinWidth
        _COXNumMin1 = int((self._DesignParameter['_Met1Layerx'][
                               '_XWidth'] - _DRCObj._CoMinWidth - _DRCObj._Metal1MinEnclosureCO2 * 2 - 2 *
                           self._DesignParameter['_Met1Layery']['_XWidth']) // (
                                      _DRCObj._CoMinWidth + _DRCObj._CoMinSpace)) + 1
        if _COXNumMin1 == 0:
            _COXNumMin1 = 1
        _COYNumMin1 = int((self._DesignParameter['_Met1Layerx'][
                               '_YWidth'] - _DRCObj._CoMinWidth - _DRCObj._Metal1MinEnclosureCO2 * 2) // (
                                      _DRCObj._CoMinWidth + _DRCObj._CoMinSpace)) + 1
        if _COYNumMin1 == 0:
            _COYNumMin1 = 1
        _COXNumMin2 = int((self._DesignParameter['_Met1Layery'][
                               '_XWidth'] - _DRCObj._CoMinWidth - _DRCObj._Metal1MinEnclosureCO2 * 2) // (
                                      _DRCObj._CoMinWidth + _DRCObj._CoMinSpace)) + 1
        if _COXNumMin2 == 0:
            _COXNumMin2 = 1
        _COYNumMin2 = int((self._DesignParameter['_Met1Layery']['_YWidth'] - _DRCObj._CoMinWidth - 2 *
                           self._DesignParameter['_Met1Layerx']['_YWidth'] - _DRCObj._Metal1MinEnclosureCO2 * 2) // (
                                      _DRCObj._CoMinWidth + _DRCObj._CoMinSpace)) + 1
        if _COYNumMin2 == 0:
            _COYNumMin2 = 1
        tmp = []
        ...
        for i in range(0, _COXNumMin1):
            for j in range(0, _COYNumMin1):
                if _COXNumMin1 % 2 == 0 and _COYNumMin1 % 2 == 0:
                    tmp.append([self._DesignParameter['_Met1Layerx']['_XYCoordinates'][0][0] - (
                                _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * (_COXNumMin1 // 2 - 0.5) + i * (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace),
                                self._DesignParameter['_Met1Layerx']['_XYCoordinates'][0][1] - (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * (
                                            _COYNumMin1 // 2 - 0.5) + j * (_DRCObj._CoMinWidth + _DRCObj._CoMinSpace)])
                    tmp.append([self._DesignParameter['_Met1Layerx']['_XYCoordinates'][1][0] - (
                                _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * (_COXNumMin1 // 2 - 0.5) + i * (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace),
                                self._DesignParameter['_Met1Layerx']['_XYCoordinates'][1][1] - (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * (
                                            _COYNumMin1 // 2 - 0.5) + j * (_DRCObj._CoMinWidth + _DRCObj._CoMinSpace)])
                    ...
                    tmp.append([self._DesignParameter['_Met1Layerx']['_XYCoordinates'][0][0] - (
                                _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * (_COXNumMin1 // 2 - 0.5) + i * (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace),
                                self._DesignParameter['_Met1Layerx']['_XYCoordinates'][0][1] - (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * ((_COYNumMin1 - 1) / 2) + j * (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace)])
                    tmp.append([self._DesignParameter['_Met1Layerx']['_XYCoordinates'][1][0] - (
                                _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * (_COXNumMin1 // 2 - 0.5) + i * (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace),
                    ...
                    tmp.append([self._DesignParameter['_Met1Layerx']['_XYCoordinates'][0][0] - (
                                _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * ((_COXNumMin1 - 1) // 2) + i * (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace),
                                self._DesignParameter['_Met1Layerx']['_XYCoordinates'][0][1] - (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * (
                                            _COYNumMin1 // 2 - 0.5) + j * (_DRCObj._CoMinWidth + _DRCObj._CoMinSpace)])
                    ...
                    tmp.append([self._DesignParameter['_Met1Layerx']['_XYCoordinates'][0][0] - (
                                ...
                                self._DesignParameter['_Met1Layerx']['_XYCoordinates'][0][1] - (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * (
                                            (_COYNumMin1 - 1) // 2) + j * (_DRCObj._CoMinWidth + _DRCObj._CoMinSpace)])
                    tmp.append([self._DesignParameter['_Met1Layerx']['_XYCoordinates'][1][0] - (
                                _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * ((_COXNumMin1 - 1) // 2) + i * (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace),
                                self._DesignParameter['_Met1Layerx']['_XYCoordinates'][1][1] - (
        ...
        for i in range(0, _COXNumMin2):
            for j in range(0, _COYNumMin2):
                if _COXNumMin2 % 2 == 0 and _COYNumMin2 % 2 == 0:
                    tmp.append([self._DesignParameter['_Met1Layery']['_XYCoordinates'][0][0] - (
                                _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * (_COXNumMin2 // 2 - 0.5) + i * (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace),
                                self._DesignParameter['_Met1Layery']['_XYCoordinates'][0][1] - (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * (
                                            _COYNumMin2 // 2 - 0.5) + j * (_DRCObj._CoMinWidth + _DRCObj._CoMinSpace)])
                    tmp.append([self._DesignParameter['_Met1Layery']['_XYCoordinates'][1][0] - (
                                _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * (_COXNumMin2 // 2 - 0.5) + i * (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace),
                                self._DesignParameter['_Met1Layery']['_XYCoordinates'][1][1] - (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * (
                                            _COYNumMin2 // 2 - 0.5) + j * (_DRCObj._CoMinWidth + _DRCObj._CoMinSpace)])
                    ...
                    tmp.append([self._DesignParameter['_Met1Layery']['_XYCoordinates'][0][0] - (
                                ...
                                self._DesignParameter['_Met1Layery']['_XYCoordinates'][0][1] - (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * (
                                            (_COYNumMin2 - 1) // 2) + j * (_DRCObj._CoMinWidth + _DRCObj._CoMinSpace)])
                    tmp.append([self._DesignParameter['_Met1Layery']['_XYCoordinates'][1][0] - (
                                _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * (_COXNumMin2 // 2 - 0.5) + i * (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace),
                                self._DesignParameter['_Met1Layery']['_XYCoordinates'][1][1] - (
                    ...
                    tmp.append([self._DesignParameter['_Met1Layery']['_XYCoordinates'][0][0] - (
                                _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * ((_COXNumMin2 - 1) // 2) + i * (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace),
                                self._DesignParameter['_Met1Layery']['_XYCoordinates'][0][1] - (
                                            _DRCObj._CoMinWidth + _DRCObj._CoMinSpace) * (
                                            _COYNumMin2 // 2 - 0.5) + j * (_DRCObj._CoMinWidth + _DRCObj._CoMinSpace)])
        ...
        if _PType == True:
            ...
            self._DesignParameter['_PPLayer']['_XYCoordinates'] = [
                [[self._DesignParameter['_Met1Layery']['_XYCoordinates'][1][0],
                  self._DesignParameter['_Met1Layery']['_XYCoordinates'][1][
                      1] + _tmpY // 2 + _tmpW + _DRCObj._PpMinExtensiononPactive2],
                 [self._DesignParameter['_Met1Layery']['_XYCoordinates'][1][0],
                 ...
                 [self._DesignParameter['_Met1Layery']['_XYCoordinates'][0][0],
                  self._DesignParameter['_Met1Layery']['_XYCoordinates'][0][1] + (_tmpY // 2 + _tmpW // 2)],
                 [self._DesignParameter['_Met1Layery']['_XYCoordinates'][1][
                      0] + _tmpW // 2 + _DRCObj._PpMinExtensiononPactive2,
                  self._DesignParameter['_Met1Layery']['_XYCoordinates'][1][1] + (_tmpY // 2 + _tmpW // 2)]
                 ]]

        if _PType == False:
            print (
                '##############################     NWELL Layer Calcuation    ##############################################')
            if _Width % 2 == 1:
            ...
            self._DesignParameter['_NWLayer']['_XYCoordinates'] = [
                [[self._DesignParameter['_Met1Layery']['_XYCoordinates'][1][0],
                  self._DesignParameter['_Met1Layery']['_XYCoordinates'][1][
                      1] + _tmpY // 2 + _tmpW + _DRCObj._NwMinEnclosurePactive],
                 [self._DesignParameter['_Met1Layery']['_XYCoordinates'][1][0],
                  self._DesignParameter['_Met1Layery']['_XYCoordinates'][1][1] - (_tmpY // 2 + _tmpW // 2)],
                 [self._DesignParameter['_Met1Layery']['_XYCoordinates'][0][0],
                  self._DesignParameter['_Met1Layery']['_XYCoordinates'][0][1] - (_tmpY // 2 + _tmpW // 2)],
                 [self._DesignParameter['_Met1Layery']['_XYCoordinates'][0][0],
                  self._DesignParameter['_Met1Layery']['_XYCoordinates'][0][1] + (_tmpY // 2 + _tmpW // 2)],
                 [self._DesignParameter['_Met1Layery']['_XYCoordinates'][1][
                      0] + _tmpW // 2 + _DRCObj._NwMinEnclosurePactive,
                  self._DesignParameter['_Met1Layery']['_XYCoordinates'][1][1] + (_tmpY // 2 + _tmpW // 2)]
                 ]]


if __name__ == '__main__':
    ans = [True, 2094.0, 875.0, 170]
    _PType = ans[0]
    _XWidth = ans[1]
    _YWidth = ans[2]
    _Width = ans[3]
